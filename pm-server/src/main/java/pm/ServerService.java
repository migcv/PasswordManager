...
public interface ServerService extends Remote {
	...
	public void register(Key publicKey, byte[] user_id, byte[] nonce, byte[] iv, byte[] signature)
			throws RemoteException;

	public ArrayList<byte[]> put(Key publicKey, byte[] user_id, byte[] read_id, byte[] domain, byte[] username,
